...
export function OrderOfferScreen({ offer, onAccept, onDecline }: OrderOfferScreenProps) {
  ...
  return (
    <View style={styles.screen}>
      ...
      <Text style={styles.price}>{offer.price.toLocaleString()} {t('som')}</Text>
...
const styles = StyleSheet.create({
  ...
  timer: { alignSelf: 'center', width: 72, height: 72, borderRadius: 36, textAlign: 'center', textAlignVertical: 'center', fontSize: 28, fontWeight: '900', color: '#ffffff', backgroundColor: '#111827' },
  ...
  label: { marginTop: 8, color: '#64748b', fontWeight: '700' },
  address: { marginTop: 4, fontSize: 17, fontWeight: '800', color: '#111827' },
  price: { marginTop: 22, textAlign: 'center', fontSize: 32, fontWeight: '900', color: '#111827' },
