...
export function BalanceScreen({ earnedToday, onBackOnline }: BalanceScreenProps) {
  return (
    <View style={styles.screen}>
      ...
      <Text style={styles.amount}>{earnedToday.toLocaleString()} сум</Text>

      <View style={styles.row}>
        <Text style={styles.rowLabel}>Доступно к выплате</Text>
        <Text style={styles.rowValue}>{earnedToday.toLocaleString()} сум</Text>
      </View>
      <View style={styles.row}>
      ...
      <Pressable onPress={onBackOnline} style={styles.primaryButton}>
        <Text style={styles.primaryText}>Вернуться на линию</Text>
      </Pressable>
    </View>
  );
}
